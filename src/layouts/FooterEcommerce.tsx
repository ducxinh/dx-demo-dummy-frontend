      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/categories" className="text-gray-400 hover:text-white">{t('footer.categories')}</Link>
            </li>
            <li>
              <Link href="/bestsellers" className="text-gray-400 hover:text-white">{t('footer.bestsellers')}</Link>
            </li>
            <li>
              <Link href="/new" className="text-gray-400 hover:text-white">{t('footer.newArrivals')}</Link>
            </li>
            <li>
              <Link href="/deals" className="text-gray-400 hover:text-white">{t('footer.dealsDiscounts')}</Link>
            </li>
            <li>
              <Link href="/school-program" className="text-gray-400 hover:text-white">{t('footer.schoolProgram')}</Link>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/faq" className="text-gray-400 hover:text-white">{t('footer.faq')}</Link>
            </li>
            <li>
              <Link href="/shipping" className="text-gray-400 hover:text-white">{t('footer.shippingReturns')}</Link>
            </li>
            <li>
              <Link href="/contact" className="text-gray-400 hover:text-white">{t('footer.contactUs')}</Link>
            </li>
            <li>
              <Link href="/track-order" className="text-gray-400 hover:text-white">{t('footer.trackOrder')}</Link>
            </li>
            <li>
              <Link href="/privacy" className="text-gray-400 hover:text-white">{t('footer.privacyPolicy')}</Link>
            </li>
          </ul>
        </div>
        <div>
