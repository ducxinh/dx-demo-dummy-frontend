...
import { resources, solutions } from '../../data'
...
export function HeaderMobile() {
  return (
    ...
    >
      ...
      >
        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-box divide-y-2 divide-gray-50">
              ...
              <nav className="grid gap-y-8">
                {solutions.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-3"
                  >
