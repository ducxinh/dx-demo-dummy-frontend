...
import UserOne from '@/assets/images/user/user-ducxinh-01.png'
  ...
  return (
    <li className="relative">
      ...
      <div
        ...
        className={`absolute -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-box shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 ${
